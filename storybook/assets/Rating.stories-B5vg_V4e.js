import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{t as n}from"./react-DDzTVtu_.js";import{t as r}from"./iframe-Ucf_MO8K.js";import{Nt as i,h as a,ht as o,t as s}from"./ui-B7sYvh9B.js";var c,l,u,d,f,p,m,h,g,_,v,y;e((()=>{c=t(n(),1),i(),s(),l=r(),u={title:`Components/Rating`,component:a,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{color:{control:`select`,options:[`default`,`primary`,`secondary`,`success`,`warning`,`danger`]},size:{control:`select`,options:[`sm`,`md`,`lg`]},count:{control:{type:`number`,min:1,max:10,step:1}},value:{control:{type:`number`,min:0,max:10,step:.5}},allowHalf:{control:`boolean`},isDisabled:{control:`boolean`},isReadOnly:{control:`boolean`}}},d={render:e=>{let[t,n]=c.useState(3);return(0,l.jsx)(a,{...e,value:t,onChange:n})},args:{color:`primary`,size:`md`,count:5}},f={render:e=>(0,l.jsx)(`div`,{className:`flex flex-col gap-4`,children:[`default`,`primary`,`secondary`,`success`,`warning`,`danger`].map(t=>(0,l.jsxs)(`div`,{className:`flex items-center gap-4`,children:[(0,l.jsxs)(`span`,{className:`w-24 text-sm capitalize`,children:[t,`:`]}),(0,l.jsx)(a,{...e,color:t,defaultValue:3})]},t))})},p={render:e=>(0,l.jsx)(`div`,{className:`flex flex-col gap-4`,children:[`sm`,`md`,`lg`].map(t=>(0,l.jsxs)(`div`,{className:`flex items-center gap-4`,children:[(0,l.jsxs)(`span`,{className:`w-24 text-sm capitalize`,children:[t,`:`]}),(0,l.jsx)(a,{...e,size:t,defaultValue:3.5,allowHalf:!0})]},t))})},m={render:e=>{let[t,n]=c.useState(3.5);return(0,l.jsxs)(`div`,{className:`flex flex-col gap-2`,children:[(0,l.jsxs)(`span`,{children:[`Current Value: `,t]}),(0,l.jsx)(a,{...e,value:t,onChange:n,allowHalf:!0})]})}},h={render:e=>{let[t,n]=c.useState(4);return(0,l.jsx)(a,{...e,value:t,onChange:n,icon:(0,l.jsx)(o,{}),color:`danger`})}},g={args:{defaultValue:4.5,isReadOnly:!0,allowHalf:!0}},_={args:{defaultValue:3,isDisabled:!0}},v={render:e=>(0,l.jsxs)(`div`,{className:`p-6 bg-background rounded-xl border border-default-100 max-w-[400px] w-full`,children:[(0,l.jsx)(`h4`,{className:`text-neutral-500 font-semibold text-sm mb-4`,children:`Product Review (Decimal / Read-only)`}),(0,l.jsx)(`div`,{className:`flex flex-col gap-3`,children:[{label:`Quality`,value:1.5},{label:`Value for money`,value:2.3},{label:`Design`,value:3.7},{label:`Durability`,value:4.2},{label:`Overall`,value:4.8}].map(t=>(0,l.jsxs)(`div`,{className:`flex items-center justify-between`,children:[(0,l.jsx)(`span`,{className:`text-sm text-neutral-600 dark:text-neutral-400 font-medium`,children:t.label}),(0,l.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,l.jsx)(a,{...e,value:t.value,color:`primary`,isReadOnly:!0,allowHalf:!0}),(0,l.jsx)(`span`,{className:`text-sm font-semibold text-neutral-600 dark:text-neutral-400 w-6 text-right`,children:t.value.toFixed(1)})]})]},t.label))})]})},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  render: args => {
