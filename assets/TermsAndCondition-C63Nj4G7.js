...
<p><em>Last updated: June 2026</em></p>`,l=()=>{let[e,t]=(0,o.useState)(c),[n,l]=(0,o.useState)(!1);return(0,s.jsxs)(`section`,{children:[(0,s.jsxs)(`div`,{className:`flex justify-between items-center`,children:[(0,s.jsx)(`p`,{className:`text-2xl`,children:`Terms & Conditions`}),(0,s.jsx)(i,{onClick:()=>{l(!0),setTimeout(()=>{l(!1),a.success(`Terms & Conditions updated successfully!`)},800)},isLoading:n,children:`Save Changes`})]}),(0,s.jsx)(`div`,{className:`my-5`,children:(0,s.jsx)(r,{value:e,onChange:t,placeholder:`Edit Terms and Conditions here...`,className:`shadow-sm`})})]})};export{l as default};