...
const variantColorClasses: Record<string, Record<string, string>> = {
  solid: {
    ...
    warning:   "border-2 border-warning bg-warning text-black",
    danger:    "border-2 border-danger bg-danger text-white",
  },
  bordered: {
  ...
  light: {
    default:   "border-2 border-transparent bg-transparent text-default-600",
  ...
  flat: {
    default:   "border-2 border-transparent bg-default-300 text-default-600",
  ...
  shadow: {
    ...
    success:   "border-2 border-success shadow-lg shadow-[color-mix(in_srgb,var(--color-success)_40%,transparent)] bg-success text-white",
    warning:   "border-2 border-warning shadow-lg shadow-[color-mix(in_srgb,var(--color-warning)_40%,transparent)] bg-warning text-black",
    danger:    "border-2 border-danger shadow-lg shadow-[color-mix(in_srgb,var(--color-danger)_40%,transparent)] bg-danger text-white",
  },
  dot: {
