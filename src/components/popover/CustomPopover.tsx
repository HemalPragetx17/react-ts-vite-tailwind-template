...
const CustomPopover: React.FC<CustomPopoverProps> = ({
    ...
    const arrowBaseClass = `absolute z-10 w-3 h-3 bg-white dark:bg-secondary-950 ${colorArrowMap[color]}`;
            ...
            <AnimatePresence>
                {open && (
                    <motion.div
                        ...
                        className={`
                            bg-white dark:bg-secondary-950 rounded-xl shadow-xl shadow-black/10
