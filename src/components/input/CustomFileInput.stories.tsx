...
import type { Image, CustomFileInputProps } from "./file-input/CustomFileInput";

const meta: Meta<typeof CustomFileInput> = {
  title: "Components/Input/CustomFileInput",
...
export default meta;
type Story = StoryObj<typeof CustomFileInput>;

// Wrapper with state for single file mode
const FileInputWithState = (props: CustomFileInputProps) => {
...
const MultiFileInputWithState = (props: CustomFileInputProps) => {
